...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>LarryAI Chatbot</title>
        <link rel="shortcut icon" href="/images/favicon.ico" />
        <meta name="description" content="Larry Ai Description" />
        <meta property="og:title" content="LarryAI Chatbot" />
        <meta property="og:description" content="Larry Ai Description" />
        <meta property="og:image" content="/images/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="LarryAI Chatbot" />
        <meta name="twitter:description" content="Larry Ai Description" />
