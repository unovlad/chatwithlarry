...
- Always provide a markdown link like this: [Check flight info](/forecast) on the same website where the user is chatting with you (so it will be <a href="/forecast">Check flight info</a>)
